...
exports.calculatePropertyPurchaseCosts = calculatePropertyPurchaseCosts;
const ratesData_1 = require("./ratesData");
/**
 ...
 */
function calculateFirstHomeBuyerConcession(stampDuty, propertyValue, state) {
    const stateRates = ratesData_1.ratesAndFees.rates[state];
 ...
 */
function calculateTransferFee(propertyValue, state) {
    const stateRates = ratesData_1.ratesAndFees.rates[state];
    ...
    switch (state) {
        ...
        case 'WA':
            ...
            if (propertyValue <= 1100000)
                return 420.30;
            if (propertyValue <= 1200000)
                return 440.30;
            if (propertyValue <= 1300000)
                return 460.30;
            if (propertyValue <= 1400000)
                return 480.30;
            if (propertyValue <= 1500000)
                return 500.30;
            if (propertyValue <= 1600000)
                return 520.30;
            if (propertyValue <= 1700000)
                return 540.30;
            if (propertyValue <= 1800000)
                return 560.30;
            if (propertyValue <= 1900000)
                return 580.30;
 ...
 */
function calculateMortgageRegistrationFee(state) {
    return ratesData_1.ratesAndFees.rates[state].fees.mortgageRegistration;
}
/**
