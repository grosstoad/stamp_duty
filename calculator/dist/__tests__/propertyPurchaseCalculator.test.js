...
describe('Property Purchase Calculator', () => {
    describe('Standard stamp duty calculations', () => {
        test('NSW standard stamp duty calculation', () => {
            ...
            const result = (0, propertyPurchaseCalculator_1.calculatePropertyPurchaseCosts)(request);
    ...
    describe('Loan purpose differences', () => {
        test('Loan purpose does not affect calculations in current implementation', () => {
            ...
            const ownerResult = (0, propertyPurchaseCalculator_1.calculatePropertyPurchaseCosts)(ownerOccupierRequest);
            const investorResult = (0, propertyPurchaseCalculator_1.calculatePropertyPurchaseCosts)(investorRequest);
